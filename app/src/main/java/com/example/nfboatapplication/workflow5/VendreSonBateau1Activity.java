...
public class VendreSonBateau1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vendre_son_bateau1);
        ...
        ArrayAdapter<String> arrayAdapter = new ArrayAdapter<String>(VendreSonBateau1Activity.this,R.layout.list_typedebateau, list_typedebateau);
        ...
        ArrayAdapter<String> arrayAdapter1 = new ArrayAdapter<String>(VendreSonBateau1Activity.this,R.layout.list_typedebateau, list_affaires_maritimes);
